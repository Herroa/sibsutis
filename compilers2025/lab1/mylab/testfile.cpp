...
int main() {
  ...
  int x = 0x2a; // Hexadecimal integer literal (base 16, the letters 'a' through
                // 'f' represent values (decimal) 10 through 15).
  int X = 0X2A;
  ...
  double d =
      0x1.4p3; // hex fraction 1.4 (decimal 1.25) scaled by 23, that is 10.0
