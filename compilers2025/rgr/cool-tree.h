...
public:
   ...
   virtual Symbol get_name() const {
      return nullptr;
   }
   virtual Symbol get_type() const {
      return nullptr;
   }
...
public:
   ...
   virtual bool is_variable() const {
      return false;  // По умолчанию выражение не является переменной
   }
   virtual Symbol get_variable_name() const {
      return nullptr;  // По умолчанию для выражений, которые не являются переменными
   }
...
public:
   ...
   Expression get_body() { return expr; };
...
public:
   ...
   bool is_variable() const override {
      return false;  // Это присваивание, а не переменная
   }
   Symbol get_variable_name() const override {
      return name;
   }
